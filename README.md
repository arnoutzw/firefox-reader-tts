...
Reader appearance follows the same model as Safari Reader: use the floating palette beside the article to choose White, Sepia, Gray, or Black; select Serif, Sans, Georgia, or Palatino; decrease or increase text size; or start Read aloud. Changes apply immediately and are restored in future reader tabs. The palette fades after a few seconds of inactivity and returns on pointer movement, hover, or keyboard focus.
